...
class CompatibilityLayer {
  constructor() {
    this.browser = window.browserDetector
      ? window.browserDetector.browser
      : "chrome";
    this.setupAPIs();
  }
...
window.compatibilityLayer = {
  ...
  sendMessage: new CompatibilityLayer().sendMessage.bind(
    new CompatibilityLayer(),
  ),
  onMessage: new CompatibilityLayer().onMessage.bind(new CompatibilityLayer()),
  setStorageData: new CompatibilityLayer().setStorageData.bind(
    new CompatibilityLayer(),
  ),
  getStorageData: new CompatibilityLayer().getStorageData.bind(
    new CompatibilityLayer(),
  ),
};
