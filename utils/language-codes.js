...
class LanguageUtils {
    ...
    static getAllLanguageOptions() {
        return Object.keys(LANGUAGE_CODES).map(code => 
            this.formatLanguageOption(code)
    ...
    static getPopularLanguages() {
        const popularCodes = ['en', 'tr', 'es', 'fr', 'de', 'it', 'pt', 'ru', 'ja', 'ko', 'zh', 'ar', 'hi'];
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { LANGUAGE_CODES, LANGUAGE_FLAGS, LanguageUtils };
}

if (typeof window !== 'undefined') {
    window.LANGUAGE_CODES = LANGUAGE_CODES;
    window.LANGUAGE_FLAGS = LANGUAGE_FLAGS;
